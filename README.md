...
Hey there! This is a demo showing how to use [Grafana Git Sync](https://grafana.com/docs/grafana/latest/observability-as-code/provision-resources/git-sync-setup/) and [grafanactl](https://github.com/grafana/grafanactl).
...
- [Step 1: Establishing GitHub Connection](https://vimeo.com/1096940275).
- [Step 2: Use Pull Request to Edit your Dashboards](https://vimeo.com/1096940806).
- [Step 3: Edit Dashboard from Github](https://vimeo.com/1096941219).
- [Step 4: Edit Dashboard with grafanactl](https://vimeo.com/1096941401).
